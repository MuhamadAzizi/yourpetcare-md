...
import com.bangkit.yourpetcare.databinding.ActivityAddDataShopBinding
...
class AddDataShopActivity : AppCompatActivity() {

    private var binding : ActivityAddDataShopBinding? = null
    private var dp: String? = null
    private val request_gallery = 1001

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAddDataShopBinding.inflate(layoutInflater)
