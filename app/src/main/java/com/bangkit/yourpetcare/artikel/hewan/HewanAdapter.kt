...
class HewanAdapter : RecyclerView.Adapter<HewanAdapter.ViewHolder>() {
    ...
    inner class ViewHolder (private val binding : ItemHewanBinding)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemHewanBinding.inflate(LayoutInflater.from(parent.context), parent, false)
